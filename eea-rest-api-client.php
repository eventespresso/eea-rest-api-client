...
/*
  ...
  Description: The Event Espresso Rest Api Client adds a shortcode that uses the EE4 JSON REST API. Compatible with Event Espresso 4.8.29 or higher. Just add the shortcode [REST_API_CLIENT] and it will list events using angular.js.
