...
$data_url = "http://dev2.eventespresso.com/wp-json/ee/v4.6/events?include=Datetime&filter[where][Datetime.DTT_EVT_end][]=>&filter[where][Datetime.DTT_EVT_end][]=" . urlencode($curdate_utc);
